...
@interface VVMoviePlayerController : UIViewController <MPMediaPlayback,VVVmapPlayerDelegate> {
    ...
    IBOutlet VVPlayerView *adPlayerView;
    ...
    IBOutlet UIImageView *transportBackground;
    VVBasicPlayer *contentPlayer, *adPlayer, *activePlayer;
    IBOutlet UIImageView *audioOnlyImage;
    IBOutlet UIImageView *posterImageView;
    id vmapPlayerReadyObserver;
    id contentScrubberUpdateObserver;
    id contentTimeUpdateObserver;
    id adTimeUpdateObserver;
    id timedThumbnailObserver;
    BOOL scaledUp;
    IBOutlet UIActivityIndicatorView *_spinner;
    NSTimeInterval seekFrom;
//    AVAssetImageGenerator *thumbnailsImageGenerator;
    IBOutlet UIToolbar *toolBar;
    CGRect originalFrame;
    BOOL statusBarHiddenBeforeViewAppearing;
    BOOL fullscreen;
    double contentVolume;
    
    VVVolarPlayerMasterController *controller;
    IBOutlet UILabel *notificationLabel;
    BOOL standAloneMode;
    BOOL audioOnly;
    
    VVMoviePlayerViewController *parentViewController;
}
