...
- (void)configurePage:(MWZoomingScrollView *)page forIndex:(NSUInteger)index {
    ...
    page.favorite = [_delegate photoBrowser:self isFavoriteAtIndex:index ];
}

- (void)forPage:(MWZoomingScrollView *)page setFavorite:(BOOL)isFav {
    [_delegate photoBrowser:self forPhoto:page.tag - PAGE_INDEX_TAG_OFFSET setFavorite:isFav];
}
